...
/* SMS context */
t_sms sms __attribute__ ((section (".bss")));
...
void sms_frame(int skip_render)
{
    ...
    if(snd.enabled)
    {
        ...
        if(sms.use_fm) YM3812UpdateOne(ym3812, snd.fm_buffer, snd.bufsize);
...
void sms_init(void)
{
    ...
    //z80_set_context((void *)0x70000000);
